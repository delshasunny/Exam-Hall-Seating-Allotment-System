...
(2, 'FIRST FLOOR - CLASS 1', 40, 0),
(3, 'EXAM HALL BLOCK B', 60, 0),
(4, 'SECOND FLOOR CLASS 1', 40, 0),
(5, 'SECOND FLOOR CLASS 2', 40, 0),
(6, 'FIRST FLOOR CLASS 2', 40, 0),
(7, 'FIRST FLOOR CLASS 3', 40, 0),
(10, 'EXAM HALL BLOCK A', 60, 0),
(11, 'BIG HALL', 60, 60),
(12, 'BSS PR', 12, 12);
...
(1, 'APARNA', 'aparnapk886@gmail.com', '0390024610415f44c9d5ca4a01dd96bb09fc95e6450bfd740a9a4cf4abcc8130', '2023-01-01', 2147483647),
...
--
ALTER TABLE `exam`
  MODIFY `id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `exam_details`
--
ALTER TABLE `exam_details`
  MODIFY `exam_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;

--
-- AUTO_INCREMENT for table `exam_summary`
--
ALTER TABLE `exam_summary`
  MODIFY `exam_summary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
