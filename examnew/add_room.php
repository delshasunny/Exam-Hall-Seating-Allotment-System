                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" action="pages/room.php" name="userform"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" minlength="3" name="name" class="form-control"
                                                placeholder=" Name" required="Minimum 2 characters required">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="5" name="strength1" class="form-control"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="5" name="strength2" class="form-control"
