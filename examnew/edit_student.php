...
if (isset($_POST["btn_update"])) {
    if ($_POST["password"] != '') {
        if ($_POST['password'] == $_POST['cpassword']) {
            ...
            extract($_POST);
            $q1 = "UPDATE `tbl_student` SET `stud_id`='$stud_id', `sfname`='$sfname',
            `sdob`='$sdob',`password`='$pass', `course_id`=$course_id WHERE `id`='" . $_GET['id'] . "'";
        } else {
...
?>
        ...
        $q1 = "UPDATE `tbl_student` SET `stud_id`='$stud_id', 
        `sfname`='$sfname',`sdob`='$sdob',,`password`='$pass',
         `course_id`=$course_id WHERE `id`='" . $_GET['id'] . "'";
    }
...
?>
<?php
$que = "SELECT a.*, b.*, b.id as COURSE_ID FROM `tbl_student` a inner join 
`tbl_class` b on a.course_id = b.id 
WHERE a.id='" . $_GET["id"] . "' ";
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" name="studentform">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="stud_id" value="<?php echo $stud_id; ?>" class="form-control" placeholder="Registration No." id="event" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="sfname" class="form-control" placeholder="First Name" id="event" value="<?php echo $sfname; ?>" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="course_id" class="form-control" placeholder="Class" required="">
