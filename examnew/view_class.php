...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 class="text-primary"> View Course</h3>
    </div>
      ...
      <div class="card-body">
        <?php if (isset($useroles)) {
          if (in_array("add_class", $useroles)) { ?>
            <a href="add_class.php"><button class="btn btn-primary">Add Course</button></a>
        <?php }
        } ?>
                  ...
                  <td>
                    <?php if (isset($useroles)) {
                      if (in_array("edit_class", $useroles)) { ?>
                        <a href="edit_class.php?id=<?= $row['id']; ?>"><button type="button" class="btn btn-xs btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                    <?php }
                    } ?>
