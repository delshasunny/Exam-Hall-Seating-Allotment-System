            ...
            <div class="form-group">
                            ...
                            <select type="text" name="class_id" id="class_id" class="form-control"   placeholder="Class" required="">
                                <option value="">--Select Class--</option>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        $s1 = "SELECT count(*) as qty FROM `tbl_student` WHERE classname='".$row["classname"]."'";
                                        $sr = $conn->query($s1);
                                        if ($sr->num_rows > 0) {
                  ...
                  <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                        <select type="text" name="subject_id" class="form-control"   placeholder="Class" required="">
                                                        <option value="">--Select --</option>
                                                            <?php  
                                                            $c1 = "SELECT distinct(subjectname) FROM `tbl_subject`";
                                                            $result = $conn->query($c1);
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="exam_id" id="exam_id" class="form-control"   placeholder="Exam" required="">
                            ...
                            <select type="text" name="room_type_id" id="room_type_id" class="form-control"   placeholder="Room" required="">
                                <option value="">--Select Room--</option>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                     ...
                                     ?>
                                            <option value="<?php echo $row["roomname"];?>" data-capacity="<?php echo $qty; ?>">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="room_capacity" id="room_capacity" class="form-control" placeholder="Room Type Capacity" >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="date" name="exam_date" id="exam_date" class="form-control" placeholder="Exam Date" >
                                                </div>
                                            </div>
                                        </div>
