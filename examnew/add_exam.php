                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" action="pages/exam.php" name="userform"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">Class</label>
                                        <div class="col-sm-9">
                                            <select type="text" name="class_id" id="class_id" class="form-control"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="subject_id" class="form-control"
                                                ...
                                                <?php
                                                // $c1     = "SELECT * FROM tbl_subject where class_id = " . $course_selected_id;
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <!-- <input type="checkbox" id="mixbatch" name="mixbatch" value="1" checked> -->
                                            <input type="checkbox" name="mixbatch" value="true" checked />
                                            <label for="mixbatch">Mix students with other batches</label>
                                        </div>
                                    </div>
                                </div>
