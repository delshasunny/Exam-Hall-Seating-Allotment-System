                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" action="pages/save_subjects.php" name="userform"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="class_id" class="form-control" placeholder="Class"
                                                required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="subjectname" class="form-control"
                                                placeholder="Subject Name" id="event" required="">
                                        </div>
                                    </div>
                                </div>
