  ...
  <div class="popup popup--icon -question js_question-popup popup--visible">
    ...
    <div class="popup__content">
      <h3 class="popup__content__title">
        ...
        <p>
          <a href="del_teacher.php?id=<?php echo $_GET['id']; ?>" class="button button--success"
                  ...
                  <td>
                    <?php if (isset($useroles)) {
                      if (in_array("edit_teacher", $useroles)) { ?>
                        <a href="edit_teacher.php?id=<?= $row['id']; ?>"><button type="button"
                            class="btn btn-xs btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>
                      <?php }
                    } ?>

                    <?php if (isset($useroles)) {
                      if (in_array("delete_teacher", $useroles)) { ?>
                        <a href="view_teacher.php?id=<?= $row['id']; ?>"><button type="button"
