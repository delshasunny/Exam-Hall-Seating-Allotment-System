...
if (isset($_POST["btn_update"])) {
    if ($_POST["password"] != '') {
        if ($_POST['password'] == $_POST['cpassword']) {
            ...
            $q1 = "UPDATE `tbl_teacher` SET `tfname`='$tfname',`temail`='$temail',`tdob`='$tdob',`tcontact`='$tcontact',`password`='$pass' WHERE `id`='" . $_GET['id'] . "'";
        } else {
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" name="teacherform">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="tfname" class="form-control" placeholder="First Name" id="event" value="<?php echo $tfname; ?>" required="">
                                        </div>
                                    </div>
                                </div>
