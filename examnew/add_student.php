                        ...
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" action="pages/save_student.php" name="studentform" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-sm-3 control-label">University Reg No.</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stud_id" class="form-control" placeholder="Registration No." id="event" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" name="course_id" class="form-control" placeholder="Course" required="">
